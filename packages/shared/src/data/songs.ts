...
export const EXPANDED_TRACKS: Track[] = [
  ...
  },
  {
    ...
    audioUrl: 'https://codeskulptor-demos.commondatastorage.googleapis.com/desolation.mp3',
    durationMs: 278000,
    trackNumber: 1,
    discNumber: 1,
    explicit: false,
...
export const GENRES_DATA: Genre[] = [
  { id: 'g1', name: 'Rabindra Sangeet', slug: 'rabindra-sangeet', color: '#1DB954', description: 'Timeless full compositions by Rabindranath Tagore' },
