...
import { ChevronLeft, ChevronRight, Search, Sparkles, User, UploadCloud } from 'lucide-react'
...
export function HeaderNav({
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between gap-4 py-4 px-2 sm:px-4 backdrop-blur-xl bg-black/20 border-b border-white/10 mb-6 rounded-2xl">
