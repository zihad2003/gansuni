...
import { Home, Search, Sparkles, Compass, Library, Heart, Music2, Plus, UploadCloud, Download } from 'lucide-react'
      ...
      <aside className="hidden lg:flex flex-col gap-3 h-fit sticky top-6">
        <div className="glass-card p-4 flex items-center justify-between">
          ...
          <button
            ...
            className="p-2 rounded-xl bg-amber-500/15 border border-amber-500/30 text-amber-400 hover:bg-amber-500/25 transition-all text-xs font-bold flex items-center gap-1"
            title="Download App"
          >
            <Download size={15} />
            <span>App</span>
